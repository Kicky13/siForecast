        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-md-10">
                    <div class="card">
                     <div class="header">
                        <h2>UBAH DATA REKANAN</h2>
                    </div>
                        <div class="body">
                         <?php foreach ($data as $row) { ?>
                            <form action="<?=base_url('index.php/supplier/updateSupplier')?>" method="post">
                                <label for="nama_supplier">Nama Perusahaan</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input required type="text" value="<?php echo $row->nama_supplier; ?>" readonly="nama_supplier" name="nama_supplier" class="form-control">
                                        <input type="hidden" value="<?php echo $row->id_supplier; ?>" name="id">
                                    </div>
                                </div>
                                <label for="harga_barang">Alamat Perusahaaan</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input required type="text"  value="<?php echo $row->alamat; ?>" name="alamat" class="form-control" >
                                    </div>
                                </div>
                                <label for="no_tlp">Nomor Telepon Perusahaan </label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input required type="number" value="<?php echo $row->no_tlp; ?>" name="no_tlp" class="form-control">
                                    </div>
                                </div>
                                <br>
                                <a href="<?php echo base_url('index.php/supplier'); ?>" class="btn bg-red m-t-15 waves-effect">BATAL/a>
                                <button required type="submit" name="update" class="btn btn-primary m-t-15 waves-effect">UBAH
                                </button>
                            </form>
                            <?php } ?>
                        </div>
