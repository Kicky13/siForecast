                ...
                <div class="info-container">
                    ...
                    <div class="btn-group user-helper-dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            <li><a href="<?php echo base_url('index.php/user/viewprofil'); ?>"><i class="material-icons">person</i>Lhat Profil</a></li>
        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>Data Persediaan <?php foreach ($barang as $item): echo $item['nama_barang']; ?>
                            <?php endforeach ?></h2>
                        </div>
                        <div class="body">
                            ...
                            style="overflow: auto">
                                <thead>
                                    <tr>
                                        <th class="col-md-2">Tanggal Barang Masuk</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><?php echo $item['tgl_barangmasuk'] ?></td>
                                        <td><?php echo $item['tgl_kadaluarsa'] ?></td>
                                        <td><?php echo $item['batas_pengembalian'] ?></td>   
                                        <td><?php echo $item['stock'] ?> Buah </td>
                                    </tr>
                                    <?php endforeach ?>      
                                </tbody>
                            </table>
                ...
                <div class="col-xs-2">
                    <div class="col-xs-2">
                    <a href="<?php echo base_url('index.php/dashboard/indexuser'); ?>" type="button"  class="btn btn-warning waves-effect"> 
                    Kembali 
                    </a>
                </div>
            </div>
