                ...
                <div class="info-container">
                    ...
                    <div class="btn-group user-helper-dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            <li><a type="button" class="btn btn-primary waves-effect" data-toggle="modal" data-target="#edituser">
                                <i class="material-icons">person</i>Lhat Profil</a></li>
                        ...
                        <?php foreach ($data as $row){ ?>
                            <form >
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="nama_user" name="nama_user" class="form-control" value="<?php echo $row->nama_user; ?>">
                                </div> 
                                <label for="no_ktp">Nomor KTP</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="number" id="no_ktp" name="no_ktp" class="form-control" value="<?php echo $row->no_ktp; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="number" id="no_telp" name="no_telp" class="form-control" value="<?php echo $row->no_telp; ?>" >
                                    </div>
                                </div>
                                <label for="jabatan">Jabatan</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="jabatan" name="jabatan" class="form-control" value="<?php echo $row->jabatan; ?>">
                                    </div>
                                </div>
                                <label for="jabatan">Username</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="jabatan" name="username" class="form-control" value="<?php echo $row->username; ?>">
                                    </div>
                                </div>
                                <label for="jabatan">Password</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="jabatan" name="password" class="form-control" value="<?php echo $row->password; ?>">
                                    </div>
                                </div>
                            </form>
                            <?php } ?> 
