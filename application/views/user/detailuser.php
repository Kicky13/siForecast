    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row clearfix">
                        ...
                        <?php foreach ($data as $row){ ?>
                            <form >
                                ...
                                <label for="nama_user">Hak Akses</label>                               
                                 <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="level" name="level" class="form-control" value="<?php echo $row->level; ?>">
                                    </div>
                                </div>
                ...
                <div class="col-xs-2">
                    <a href="<?php echo base_url('index.php/stok'); ?>" type="button"  class="btn btn-warning waves-effect"> 
                    Kembali 
                    </a>
                </div>
                </div>
