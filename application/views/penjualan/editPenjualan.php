                    ...
                    <div class="card">
                     <div class="header">
                        ...
                        <div class="body">
                            ...
                            <form action="<?php echo base_url("index.php/penjualan/updatePenjualan"); ?>" method="post">
                                ...
                                <br>
                                <a href="<?php echo base_url("index.php/penjualan"); ?>" class="btn bg-red m-t-15 waves-effect">BATAL</a>
