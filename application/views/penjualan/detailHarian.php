        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-md-10">
                    <div class="card">
                        <div class="header">
                            <h2>DETAIL PENJUALAN TANGGAL <?php foreach ($tanggal as $item): echo $item['tgl_penjualan']; ?>
                            <?php endforeach ?></h2>
                        </div>
                        <div class="body">
                ...
                <div class="col-md-4">
                    <a href="<?php echo base_url('index.php/penjualan/harian'); ?>" type="button" class="btn btn-primary waves-effect">
