                ...
                <div class="col-md-5">
                    <div class="card">
                        ...
                        <div class="body" style="overflow: auto">
                            <form action="<?=base_url('index.php/penjualan/harian')?>" method="get">
                                <div class="row">                               
                                    <div class="col-md-4">
                                        <select name="bulan">
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover">
                                <thead>
                                    <tr>
                                        <th class="col-md-4">Tanggal Penjualan</th>
                                    ...
                                    <?php foreach ($tanggal as $row){ ?>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a href="<?php echo base_url('index.php/penjualan/detailHarian/'.$row->tgl_penjualan); ?>" type="button" class="btn btn-primary waves-effect">
