                    ...
                    <div class="card">
                     <div class="header">
                        ...
                        <div class="body">
                            ...
                            <form action="<?php echo base_url("index.php/barang/updateBarang"); ?>" method="post">
                                <label for="nama_barang">Nama Barang</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input required type="text"  value="<?php echo $row->nama_barang; ?>" id="nama_barang" name="nama_barang" class="form-control">
                                        <input required type="hidden" value="<?php echo $row->id_barang; ?>" name="id">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input required type="text" readonly="nama_supplier" value="<?php echo $row->nama_supplier; ?>" class="form-control">
                                    </div>
                                </div>
                                <label for="alamatp">Harga Barang</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input required type="number" value="<?php echo $row->harga_barang; ?>" id="harga_barang" name="harga_barang" class="form-control" >
                                    </div>
                                </div>
                                <label for="no_tlp">Waktu Pengiriman</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input required type="number" value="<?php echo $row->waktu_pengiriman; ?>" id="waktu_pengiriman" name="waktu_pengiriman" class="form-control">
                                    </div>
                                </div>
                                <br>
                                <a href="<?php echo base_url("index.php/barang"); ?>" class="btn bg-red m-t-15 waves-effect">BATAL</a>
                                <button type="submit"value="update" class="btn btn-primary m-t-15 waves-effect">UBAH
                                </button>
                            </form>
                            <?php } ?>
                        </div>
