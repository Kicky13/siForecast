    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row clearfix">
                            ...
                            style="overflow: auto">
                                ...
                                <?php foreach ($data as $row){ ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url('index.php/barang/statusbarang/'.$row->id_barang); ?>" type="button" class="btn bg-red waves-effect">
                                                 <i class="material-icons">visibility_off</i>
                                            </a>
                                            <a href="<?php echo base_url('index.php/barang/viewUpdate/'.$row->id_barang); ?>" type="button" class="btn btn-primary waves-effect">
                ...
                <div class="col-xs-2">
                    <div class="col-xs-2">
                    <a href="<?php echo base_url('index.php/barang/formbarang'); ?>" type="button"  class="btn btn-primary waves-effect"> 
