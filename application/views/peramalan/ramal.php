...
<body class="theme-red">
    ...
    <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-md-11">
                    <div class="card">
                        <div class="body">
                            <form action="<?=base_url('index.php/peramalan/ramal')?>" method="post">                                
                                ...
                                <button type="submit" name="submit" class="btn btn-primary m-t-15 waves-effect">Ramal</button>                                                             
                            </form>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            style="overflow: auto">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="col-md-2">Tanggal Ramal</th>
                                        <th class="col-md-2">Nilai Aktual</th>
                                        <th class="col-md-2">Nilai Peramalan</th>
                                        <th class="col-md-2">Nilai Mape</th>
                                ...
                                <?php foreach ($hasil as $row){ ?>
                                    <tr>
                                        ...
                                        <td><?php echo $row->tgl_ramal?></td>
                                        <td><?php echo $row->nilai_aktual?></td> 
                                        <td><?php echo $row->nilai_ramal?></td> 
                                        <td><?php echo $row->nilai_mape?></td>    
                         ...
                         <button onclick="saran()" type="button" class="btn btn-primary m-t-15 waves-effect">SARAN</button>
                    </div>
    ...
    <script>
        function saran() {
            swal({
                    title: "Konfirmasi Saran",
                    text: "Apakah Anda yakin ingin meminta saran ?",
                    type: "info",
                ...
                function(){
                    $.get( "<?php echo base_url('index.php/peramalan/getSaran'); ?>", function(data) {
                        swal(data);
                    });
                });
        }
