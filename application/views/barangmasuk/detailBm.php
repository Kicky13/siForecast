        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>Detail Barang Masuk <?php foreach ($tanggal as $item): echo $item['tgl_barangmasuk']; ?>
                            <?php endforeach ?></h2>
                        </div>
                        <div class="body">
                ...
                <div class="col-xs-2">
                    <a href="<?php echo base_url('index.php/barangmasuk'); ?>" type="button" class="btn btn-warning waves-effect"> 
