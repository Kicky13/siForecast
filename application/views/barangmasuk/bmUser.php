...
<body class="theme-red">
   ...
   <nav class="navbar">
    ...
    <section class="content">
        <div class="container">
            <form class="well form-horizontal" action="<?=base_url('index.php/barangmasuk/addBarangmasuk')?>" method="post"  id="contact_form">
                <fieldset>
                    <div class="form-group"> 
                        ...
                        <div class="col-md-4 selectContainer">
                            <div class="input-group">
                                ...
                                <select name="id_barang" id="id_barang"class="form-control selectpicker" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4 inputGroupContainer">
                            <div class="input-group">
                                ...
                                <input required name="jumlah" id="jumlah" class="form-control"  type="number">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4 inputGroupContainer">
                            <div class="input-group">
                                ...
                                <input required name="tgl_kadaluarsa" id="tgl_kadaluarsa" class="form-control" type="date">
                            </div>
                        </div>
                    </div>
  
                    <div class="form-group">
                        <label class="col-md-4 control-label">Batas Pengembalian</label>  
                        <div class="col-md-4 inputGroupContainer">
                            <div class="input-group">
                                 <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                <input required name="batas_pengembalian" id="batas_pengembalian" class="form-control" type="date">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <button type="submit" name="submit" class="btn bg-red" >Tambahkan</span></button>
                        </div>
                    </div>
                            ...
                            style="overflow: auto">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="col-md-2">Tanggal Kadaluarsa</th>
                                ...
                                <?php foreach ($datamasuk as $row){ ?>
                                    <tr >
                                        ...
                                        <td>
                                            <a href="<?php echo base_url('index.php/barangmasuk/viewUpdate/'.$row->id_barangmasuk); ?>" type="button" class="btn btn-primary waves-effect">
