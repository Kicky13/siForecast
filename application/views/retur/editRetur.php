                            ...
                            <form action="<?php echo base_url("index.php/retur/updateRetur"); ?>" method="post">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <input type="hidden" value="<?php echo $row->id_pengembalian; ?>" name="id">
                                    </div>
                                </div>
                                ...
                                <br>
                                <a href="<?php echo base_url("index.php/retur"); ?>" class="btn bg-red m-t-15 waves-effect">BATAL</a>
                                <button type="update"value="update" class="btn btn-primary m-t-15 waves-effect">SIMPAN
                                </button>
                            </form>
                            <?php } ?>
                        </div>
