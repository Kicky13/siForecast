...
<body class="theme-red">
   ...
   <nav class="navbar">
    ...
    <section class="content">
        <div class="container">
            <form class="well form-horizontal" action="<?=base_url('index.php/retur/addRetur')?>" method="post"  id="contact_form">
                <fieldset>
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            style="overflow: auto">
                                <thead>
                                    <tr>
                                        <th class="col-md-3">tgl_pengembalian</th>
                                ...
                                <?php foreach ($dataretur as $row){ ?>
                                    <tr >
                                        ...
                                        <td>
                                            <a href="<?php echo base_url('index.php/retur/viewUpdate/'.$row->id_pengembalian); ?>" type="button" class="btn btn-primary waves-effect">
