        ...
        <div class="container-fluid">
             ...
             <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>Data Barang Retur Per-Tanggal</h2>
                        </div>
                       <div class="body" style="overflow: auto">
                            <form action="<?=base_url('index.php/retur')?>" method="get">
                                <div class="row">                               
                                    <div class="col-md-4">
                                        <select name="bulan">
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover">
                                <thead>
                                    <tr>
                                        <th class="col-md-5">Tanggal Barang Retur</th>                               
                                    ...
                                    <?php foreach ($tanggal as $row){ ?>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a href="<?php echo base_url('index.php/retur/viewDetail/'.$row->tgl_pengembalian); ?>" type="button" class="btn btn-primary waves-effect">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            style="overflow: auto">
                                <thead>
                                    <tr>
                                        <th class="col-md-2">Tanggal Retur</th>
                                        <th class="col-md-3">Nama Barang</th>
                                        <th class="col-md-2">jumlah</th>  
                                        <th class="col-md-2">Kadaluarsa</th>
                                        <th class="col-md-3">Pegawai</th>        
                                    </tr>
                                </thead>
